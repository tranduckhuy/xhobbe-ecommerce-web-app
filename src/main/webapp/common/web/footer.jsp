            ...
            <div class="row no-gutters bg-white newsletter-popup-content">
                <div class="col-xl-3-5col col-lg-7 banner-content-wrap">
                    <div class="banner-content text-center">
                        <img src="<c:url value='/template/web/assets/images/demos/demo-4/xhobbe-high-resolution-logo.png'/>" class="logo" alt="logo" width="60" height="15">
                ...
                <div class="col-xl-2-5col col-lg-5 ">
                    <img src="<c:url value='/template/web/assets/images/popup/newsletter/img-1.jpg'/>" class="newsletter-img" alt="newsletter">
                </div>
            </div>
        </div>
    </div>
