                        ...
                        <div class="product-gallery product-gallery-vertical">
                            <div class="row">
                                ...
                                <div id="product-zoom-gallery" class="product-image-gallery">
                                    ...
                                    <a class="product-gallery-item" href="#" data-image="<c:url value='/template/web/assets/images/products/single/centered/2.jpg'/>" data-zoom-image="<c:url value='/template/web/assets/images/products/single/centered/2-big.jpg'/>">
                                        <img src="<c:url value='/template/web/assets/images/products/single/centered/2-small.jpg'/>" alt="product cross">
                                    </a>

                                    <a class="product-gallery-item" href="#" data-image="<c:url value='/template/web/assets/images/products/single/centered/3.jpg'/>" data-zoom-image="<c:url value='/template/web/assets/images/products/single/centered/3-big.jpg'/>">
                                        <img src="<c:url value='/template/web/assets/images/products/single/centered/3-small.jpg'/>" alt="product with model">
                                    </a>

                                    <a class="product-gallery-item" href="#" data-image="<c:url value='/template/web/assets/images/products/single/centered/4.jpg'/>" data-zoom-image="<c:url value='/template/web/assets/images/products/single/centered/4-big.jpg'/>">
                                        <img src="<c:url value='/template/web/assets/images/products/single/centered/4-small.jpg'/>" alt="product back">
                                    </a>
