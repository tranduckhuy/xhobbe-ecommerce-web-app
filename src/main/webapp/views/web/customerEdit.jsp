                        ...
                        <div class="tab-pane fade show active" id="register-2" role="tabpanel" aria-labelledby="register-tab-2">
                            ...
                            <form action="account" method="post" id="form-customer-edit-account">
                                ...
                                <div class="d-flex justify-content-between mt-3">
                                    ...
                                    <a href="./account?action=changePassword" class="font-italic font-weight-bold" style="text-decoration: underline">
                                        Change Your Password? <i class="fa-solid fa-right-long"></i>
                                    </a>
                                </div>
                            </form>
                        </div><!-- .End .tab-pane -->
