    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-6 deal-col">
                <div class="deal" style="background-image: url('<c:url value='/template/web/assets/images/demos/demo-4/deal/bg-1.jpg'/>');">
                    <div class="deal-top">
                    ...
                    <div class="deal-content">
                        <h3 class="product-title"><a href="product-centered.html">Home Smart Speaker with Google
                        ...
                        <a href="product-centered.html" class="btn btn-link"><span>Shop Now</span><i
                                class="icon-long-arrow-right"></i></a>
            ...
            <div class="col-lg-6 deal-col">
                <div class="deal" style="background-image: url('<c:url value='/template/web/assets/images/demos/demo-4/deal/bg-2.jpg'/>');">
                    <div class="deal-top">
                    ...
                    <div class="deal-content">
                        <h3 class="product-title"><a href="product-centered.html">Certified Wireless Charging Pad
                            for iPhone / Android</a></h3><!-- End .product-title -->
        ...
        <div class="container trending-products">
            ...
            <div class="row">
                <div class="col-xl-5col d-none d-xl-block">
                    <div class="banner">
                        <a href="#">
                            <img src="<c:url value='/template/web/assets/images/demos/demo-4/banners/banner-4.jpg'/>" alt="banner">
                        </a>
                    </div><!-- End .banner -->
                </div><!-- End .col-xl-5col -->
                            ...
                            <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow"
                                ...
                                <div class="product product-2">
                                    <figure class="product-media">
                                        ...
                                        <div class="product-action">
                                            <a href="cart.html" class="btn-product btn-cart"
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-title"><a href="product-centered.html">Bose - SoundSport
                                ...
                                <div class="product product-2">
                                    <figure class="product-media">
                                        <a href="product-centered.html">
                                            <img src="<c:url value='/template/web/assets/images/demos/demo-4/products/product-7.jpg'/>"
                                                 alt="Product image" class="product-image">
                                        </a>
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-title"><a href="product-centered.html">Microsoft -
                                ...
                                <div class="product product-2">
                                    <figure class="product-media">
                                        <span class="product-label label-circle label-new">New</span>
                                        <a href="product-centered.html">
                                            <img src="<c:url value='/template/web/assets/images/demos/demo-4/products/product-8.jpg'/>"
                                                 alt="Product image" class="product-image">
                                        </a>
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-title"><a href="product-centered.html">Apple Watch Series
                                ...
                                <div class="product product-2">
                                    <figure class="product-media">
                                        ...
                                        <span class="product-label label-circle label-sale">Sale</span>
                                        <a href="product-centered.html">
                                            <img src="<c:url value='/template/web/assets/images/demos/demo-4/products/product-9.jpg'/>"
                                                 alt="Product image" class="product-image">
                                        </a>
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-title"><a href="product-centered.html">Sony - Class LED
                                ...
                                <div class="product product-2">
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-title"><a href="product-centered.html">Apple - 11 Inch
                        ...
                        <div class="tab-pane p-0 fade" id="trending-best-tab" role="tabpanel"
                            ...
                            <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow"
                                ...
                                <div class="product product-2">
                                    <figure class="product-media">
                                        <a href="product-centered.html">
                                            <img src="<c:url value='/template/web/assets/images/demos/demo-4/products/product-2.jpg'/>"
                                                 alt="Product image" class="product-image">
                                        </a>
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-title"><a href="product-centered.html">Bose - SoundLink
                                ...
                                <div class="product product-2">
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-title"><a href="product-centered.html">Google - Pixel 3
                                            XL 128GB</a></h3><!-- End .product-title -->
                                        <div class="product-price">
                                            <span class="new-price">$35.41</span>
                                            <span class="old-price">Was $41.67</span>
                                        </div><!-- End .product-price -->
                                ...
                                <div class="product product-2">
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-title"><a href="product-centered.html">Samsung - 55"
                                            Class LED 2160p Smart</a></h3><!-- End .product-title -->
                                        <div class="product-price">
                                            $899.99
                                        </div><!-- End .product-price -->
                                        <div class="ratings-container">
                                ...
                                <div class="product product-2">
                                    <figure class="product-media">
                                        <span class="product-label label-circle label-top">Top</span>
                                        <a href="product-centered.html">
                                            <img src="<c:url value='/template/web/assets/images/demos/demo-4/products/product-1.jpg'/>"
                                                 alt="Product image" class="product-image">
                                        </a>
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-title"><a href="product-centered.html">MacBook Pro 13"
            ...
            <div class="row justify-content-center">
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="product product-2">
                        <figure class="product-media">
                            <span class="product-label label-circle label-sale">Sale</span>
                            <a href="product-centered.html">
                                <img src="<c:url value='/template/web/assets/images/demos/demo-4/products/product-10.jpg'/>" alt="Product image"
                                     class="product-image">
                            </a>
                        ...
                        <div class="product-body">
                            ...
                            <h3 class="product-title"><a href="product-centered.html">Beats by Dr. Dre Wireless
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="product product-2">
                        <figure class="product-media">
                            <a href="product-centered.html">
                                <img src="<c:url value='/template/web/assets/images/demos/demo-4/products/product-11.jpg'/>" alt="Product image"
                                     class="product-image">
                            </a>
                        ...
                        <div class="product-body">
                            ...
                            <h3 class="product-title"><a href="product-centered.html">GoPro - HERO7 Black HD
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="product product-2">
                        <figure class="product-media">
                            <span class="product-label label-circle label-new">New</span>
                            <a href="product-centered.html">
                                <img src="<c:url value='/template/web/assets/images/demos/demo-4/products/product-12.jpg'/>" alt="Product image"
                                     class="product-image">
                                <img src="<c:url value='/template/web/assets/images/demos/demo-4/products/product-12-2.jpg'/>" alt="Product image"
                        ...
                        <div class="product-body">
                            ...
                            <h3 class="product-title"><a href="product-centered.html">Apple - Apple Watch Series 3
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="product product-2">
                        <figure class="product-media">
                            <a href="product-centered.html">
                                <img src="<c:url value='/template/web/assets/images/demos/demo-4/products/product-13.jpg'/>" alt="Product image"
                                     class="product-image">
                            </a>
                        ...
                        <div class="product-body">
                            ...
                            <h3 class="product-title"><a href="product-centered.html">Lenovo - 330-15IKBR 15.6"</a>
                            </h3><!-- End .product-title -->
                            <div class="product-price">
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="product product-2">
                        <figure class="product-media">
                            <a href="product-centered.html">
                                <img src="<c:url value='/template/web/assets/images/demos/demo-4/products/product-14.jpg'/>" alt="Product image"
                                     class="product-image">
                            </a>
                        ...
                        <div class="product-body">
                            ...
                            <h3 class="product-title"><a href="product-centered.html">Sony - Alpha a5100 Mirrorless
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="product product-2">
                        <figure class="product-media">
                            <a href="product-centered.html">
                                <img src="<c:url value='/template/web/assets/images/demos/demo-4/products/product-15.jpg'/>" alt="Product image"
                                     class="product-image">
                            </a>
                        ...
                        <div class="product-body">
                            ...
                            <h3 class="product-title"><a href="product-centered.html">Home Mini - Smart Speaker with
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="product product-2">
                        <figure class="product-media">
                            <span class="product-label label-circle label-sale">Sale</span>
                            <a href="product-centered.html">
                                <img src="<c:url value='/template/web/assets/images/demos/demo-4/products/product-16.jpg'/>" alt="Product image"
                                     class="product-image">
                            </a>
                        ...
                        <div class="product-body">
                            ...
                            <h3 class="product-title"><a href="product-centered.html">WONDERBOOM Portable Bluetooth
                                Speaker</a></h3><!-- End .product-title -->
                            <div class="product-price">
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="product product-2">
                        <figure class="product-media">
                            <a href="product-centered.html">
                                <img src="<c:url value='/template/web/assets/images/demos/demo-4/products/product-17.jpg'/>" alt="Product image"
                                     class="product-image">
                            </a>
                        ...
                        <div class="product-body">
                            ...
                            <h3 class="product-title"><a href="product-centered.html">Google - Home Hub with Google
                                Assistant</a></h3><!-- End .product-title -->
                            <div class="product-price">
                                $149.00
                            </div><!-- End .product-price -->
